      ...
      <div class="logreg-box">
          <div class="form-box login" >
              <form action="#">
                  ...
                  <div>
                      <p>Não tem uma conta?
                        <router-link to="/Register" style="color: brown;"><p> Registre-se </p></router-link>
                        </p>
                  </div>
              </form>
          </div>
...
.header{
  ...
  align-items: center;
  z-index: 100;
  background-color: rgb(133, 101, 138);
}
...
.container{
  ...
  width: 75%;
  height: 550px;
  background: url(../assets/download.jpeg) no-repeat;
  background-size: 100%;
  background-position: center;
  border-radius: 10px;
  margin-top: 10px;
...
box-shadow: 0 0 0 4px rgba(146, 55, 55, 0.521);
}
